...
h3. Requirements for Octave-based models

* Octave environment (tested with 3.6.2)
* Optim package (http://octave.sourceforge.net/optim/)

h3. Requirements for Matlab-based models

* Matlab environment
* Optimization toolbox
* Compiler toolbox

h3. Requirements for SBTOOLBOX2-based models
...
h3. Octave / Matlab model

# Clone the repository

# Navigate to the models folder

# Navigate to the algebraic or differential folder, depending on the model type. If it is defined as an algebraic equation or as an differential, choose the right folder

# Copy the TEMPLATE folder and name it to the model name

# Open each of the .m files and change it accordingly
