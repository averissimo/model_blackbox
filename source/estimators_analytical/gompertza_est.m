...
%
    ...
    if nargin > 0 && test_data
        ...
        s = 'time=[0.0,60.0,120.0,180.0,210.0,250.0,270.0,315.0,345.0,375.0,405.0,425.0]&values=[0.102,0.242,0.717,1.52,1.798,2.114,2.666,3.156,3.964,4.048,4.362,4.646]&estimation=%7B%22states%22:[%7B%22name%22:%22miu%22,%22bottom%22:0.0,%22top%22:3.0%7D,%7B%22name%22:%22lambda%22,%22bottom%22:-5.0,%22top%22:5.0%7D,%7B%22name%22:%22A%22,%22bottom%22:0.0,%22top%22:10.0%7D]%7D';
        s = 'time=[0.0,60.0,120.0,180.0,210.0,250.0,270.0,315.0,345.0,375.0,405.0,425.0]&values=[0.102,0.242,0.717,1.52,1.798,2.114,2.666,3.156,3.964,4.048,4.362,4.646]&estimation=%7B"states":[%7B"name":"miu","bottom":0.0,"top":3.0%7D,%7B"name":"lambda","bottom":-5.0,"top":120.0%7D,%7B"name":"A","bottom":0.0,"top":10.0%7D]%7D';
        input = qs2struct( s );
    else
